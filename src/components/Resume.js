    ...
    return (
        <div className="row justify-content-center">
          ...
          <div className="card-body">
            ...
            <p><a href="mailto:thabrez@gmail.com">{info.basic.email}</a></p>
          ...
          <div className="card-body">
              ...
              <h4 style={{textAlign:"left"}}><strong>Programming skills : </strong><span style={{fontSize:"16px"}}>{info.techskills.Pro}</span></h4>
              <h4 style={{textAlign:"left"}}><strong>Data Base : </strong><span style={{fontSize:"16px"}}>{info.techskills.data}</span></h4>
              <h4 style={{textAlign:"left"}}><strong>Operating System: </strong><span style={{fontSize:"16px"}}>{info.techskills.operating}</span></h4>
